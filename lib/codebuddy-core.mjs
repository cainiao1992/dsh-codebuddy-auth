...
/**
 * The VSCode-shaped identity the /v3/config catalog endpoint demands — it
 * answers 400 to any other User-Agent (verified empirically), unlike the
 * chat plane which accepts the CLI identity above. fetchRemoteModels is the
 * only consumer; kept separate from DEFAULTS so the two planes' identities
 ...
 *  User-Agent (CATALOG_IDENTITY): the endpoint answers 400 to any other
 *  (verified empirically; /v2/chat/completions itself accepts any UA). */
