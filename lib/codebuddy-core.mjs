 ...
 * `reasoning` metadata: `supportedEfforts` become the selectable levels, a
 * fixed `effort` becomes a single level, and `canDisableThinking` adds an
 * `off` (disable) level. A model with no reasoning metadata is declared
 * non-reasoning (`false`).
 *
